...
namespace Turingforge::Backend::detail::fast_approx {
    inline auto constexpr PowV1(Turingforge::Scalar x, Turingforge::Scalar y) -> Turingforge::Scalar {
        ...
        inline auto PowV2(Turingforge::Scalar x, Turingforge::Scalar y) {
            auto log2 = [](Turingforge::Scalar x) {
            ...
            auto pow2 = [](Turingforge::Scalar p) {
        ...
        inline auto PowImpl(Turingforge::Scalar x, Turingforge::Scalar y) -> Turingforge::Scalar {
