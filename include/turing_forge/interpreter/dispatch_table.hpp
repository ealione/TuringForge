...
//requires std::is_arithmetic_v<T>
        ...
        using Callable = std::function<void(Turingforge::Vector<Node> const&, Backend::View<T, S>, size_t, Turingforge::Range)>;

        template<typename T, std::size_t S>
        using CallableDiff = std::function<void(Turingforge::Vector<Node> const&, Backend::View<T const, S>, Backend::View<T, S>, int, int)>;
...
//    if arity > 4, one accumulation is performed every 4 args
        ...
        static inline void NaryOp(Turingforge::Vector<Node> const& nodes, Backend::View<T, S> data, size_t parentIndex, Turingforge::Range /*unused*/)
        {
        ...
        static inline void BinaryOp(Turingforge::Vector<Node> const& nodes, Backend::View<T, S> m, size_t i, Turingforge::Range /*unused*/)
        {
            auto j = i - 1;
        ...
        static inline void UnaryOp(Turingforge::Vector<Node> const& /*unused*/, Backend::View<T, S> m, size_t i, Turingforge::Range /*unused*/)
        {
        ...
        template<NodeType Type, typename T, std::size_t S>
        static inline void DiffOp(Turingforge::Vector<Node> const& nodes, Backend::View<T const, S> primal, Backend::View<T, S> trace, int i, int j) {
    ...
    public:
        ...
        template<typename T>
        [[nodiscard]] inline auto TryGetFunction(Turingforge::Hash const h) const noexcept -> std::optional<Callable<T>>
        {
            if (auto it = map_.find(h); it != map_.end()) {
        ...
        template<typename T>
        [[nodiscard]] inline auto TryGetDerivative(Turingforge::Hash const h) const noexcept -> std::optional<CallableDiff<T>>
        {
            if (auto it = map_.find(h); it != map_.end()) {
