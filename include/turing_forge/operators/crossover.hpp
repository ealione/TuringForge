...
public:
    ...
    auto operator()(Turingforge::RandomGenerator& random, const Tree& lhs, const Tree& rhs) const -> Tree override;
    auto FindCompatibleSwapLocations(Turingforge::RandomGenerator& random, const Tree& lhs, const Tree& rhs) const -> std::pair<size_t, size_t>;
