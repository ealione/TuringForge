...
namespace Turingforge {
    ...
    inline auto EfficientSortImpl(Turingforge::Span<Turingforge::Individual const> pop, Turingforge::Scalar /*unused*/) -> NondominatedSorterBase::Result
    {
    ...
    auto EfficientBinarySorter::Sort(Turingforge::Span<Turingforge::Individual const> pop, Turingforge::Scalar eps) const -> NondominatedSorterBase::Result
    {
        return EfficientSortImpl<EfficientSortStrategy::Binary>(pop, eps);
    }

    auto EfficientSequentialSorter::Sort(Turingforge::Span<Turingforge::Individual const> pop, Turingforge::Scalar eps) const -> NondominatedSorterBase::Result
    {
