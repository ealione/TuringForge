...
auto RankIntersectSorter::Sort(Turingforge::Span<Turingforge::Individual const> pop, Turingforge::Scalar /*unused*/) const -> NondominatedSorterBase::Result
{
